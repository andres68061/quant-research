...
Daily-update counterpart of the bulk downloader (``scripts/ingest/fetch_fmp_prices.py``):
...
from core.data.vendors.fmp.prices import fetch_dividend_adjusted_history
