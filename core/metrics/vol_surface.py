...
from core.metrics.black_scholes import OptionKind, implied_volatility
...
def implied_vol_surface_grid(
    ...
    *,
    ...
    sigma_low, sigma_high : float
        Volatility search bracket for :func:`~core.metrics.black_scholes.implied_volatility`.
    ...
    Examples
    --------
    >>> from core.metrics.black_scholes import black_scholes_price
    >>> sig = 0.2
