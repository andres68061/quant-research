...
Usage:
    python scripts/build/add_quote_type.py
    python scripts/build/add_quote_type.py --force  # Re-fetch all
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python scripts/build/add_quote_type.py",
    )
    parser.add_argument(
    ...
    if df is None or df.empty:
        ...
        print("   Run: python scripts/ingest/fetch_sectors.py")
        return
