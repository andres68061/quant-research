...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_event_factors.py
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_event_factors.py --symbols AAPL,MSFT
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_event_factors.py --only earnings
"""
...
from core.data.store.artifacts import streamed_artifact
