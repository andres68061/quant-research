...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_fmp_universe.py
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_fmp_universe.py --min-market-cap 2e9
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_fmp_universe.py --no-delisted
"""
...
from core.data.vendors.fmp.universe import US_EXCHANGES, build_universe, fetch_live_universe
