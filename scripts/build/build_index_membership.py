...
Source: the S&P historical membership CSV via ``core.data.universe.sp500_constituents``
...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_index_membership.py
"""
