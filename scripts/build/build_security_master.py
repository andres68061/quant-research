...
get new ids. See :mod:`core.data.universe.security_master` for why the id is opaque and
...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_security_master.py
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_security_master.py --fetch-cik
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_security_master.py --dry-run
"""
...
from core.data.store.artifacts import write_artifact  # noqa: E402
from core.data.universe.security_master import (  # noqa: E402
    ALIAS_FILE,
    MASTER_FILE,
...
def load_cik_map() -> dict[str, str]:
    ...
    from core.data.vendors.sec.client import fetch_company_tickers
