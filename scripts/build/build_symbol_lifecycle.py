...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_symbol_lifecycle.py
    /opt/anaconda3/envs/quant/bin/python scripts/build/build_symbol_lifecycle.py --apply
"""
