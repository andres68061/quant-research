...
No network access: this reads the raw layer that scripts/fetch_fmp_fundamentals.py
already downloaded.

Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build_fundamentals_panel.py
    /opt/anaconda3/envs/quant/bin/python scripts/build_fundamentals_panel.py --symbols AAPL,MSFT
"""
...
def main() -> None:
    ...
    if args.expanded:
        from core.data.fmp.storage import load_universe_symbols, safe_filename
