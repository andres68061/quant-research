...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/build_ohlcv_panel.py
    /opt/anaconda3/envs/quant/bin/python scripts/build_ohlcv_panel.py --symbols AAPL,MSFT
    /opt/anaconda3/envs/quant/bin/python scripts/build_ohlcv_panel.py --window 63
"""
...
from core.data.artifacts import write_artifact
...
from core.data.fmp.storage import load_trading_calendar, load_universe_symbols, safe_filename
