...
def check_existing_data(sp500: SP500Constituents) -> pd.DataFrame:
    ...
    for ticker in sorted(all_tickers):
        ...
        results.append({"ticker": ticker, "has_data": has_data})
...
def main():
    ...
    for i, (ticker, row) in enumerate(longevity_df.head(10).iterrows(), 1):
        ...
        print(
            f"  {i:2d}. {ticker:8s} - {years:.1f} years "
    ...
    print("   from core.data.universe.sp500_constituents import SP500Constituents")
