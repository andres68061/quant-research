...
Usage:
    ...
    /opt/anaconda3/envs/quant/bin/python scripts/experiments/screen_factor_library.py --factors accruals,roa
"""
...
from core.data.universe.filters import build_universe_filter
