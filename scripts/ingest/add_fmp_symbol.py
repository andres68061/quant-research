...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/add_fmp_symbol.py --symbols BNY
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/add_fmp_symbol.py --symbols BNY --rebuild-factors
"""
...
from core.data.vendors.fmp.panel import add_symbol_to_fmp_panel
