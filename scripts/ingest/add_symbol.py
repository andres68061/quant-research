...
Usage:
    ...
    python scripts/ingest/add_symbol.py NVDA TSLA AMZN
"""
...
from core.data.universe.sector_classification import add_or_update_sectors
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python scripts/ingest/add_symbol.py NVDA TSLA",
    )
    parser.add_argument("symbols", nargs="+", help="Stock ticker symbol(s) to add")
    parser.add_argument(
        "--out",
        type=str,
