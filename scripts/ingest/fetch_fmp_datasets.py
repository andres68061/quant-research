...
Usage:
    ...
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_datasets.py --datasets all

    # one dataset, explicit symbols
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_datasets.py \
...
from core.data.vendors.fmp.datasets import SYMBOL_DATASETS, describe_datasets, fetch_symbol_dataset
