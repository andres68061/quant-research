...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_fundamentals.py
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_fundamentals.py --symbols AAPL,GE
"""
...
from core.data.vendors.fmp.fundamentals import STATEMENT_ENDPOINTS, fetch_quarterly_statement
