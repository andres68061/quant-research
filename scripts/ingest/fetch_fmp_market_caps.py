...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_market_caps.py
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_market_caps.py --symbols AAPL,MSFT
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_fmp_market_caps.py --build-only
"""
...
from core.data.vendors.fmp.market_caps import (
    DEFAULT_START,
