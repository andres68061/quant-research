...
Usage:
    python scripts/ingest/fetch_raw_macro.py
    python scripts/ingest/fetch_raw_macro.py --out data/raw/macro_fred.parquet
"""
...
from core.data.store.duckdb_io import write_parquet  # noqa: E402
