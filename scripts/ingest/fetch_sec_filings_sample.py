...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_sec_filings_sample.py
    /opt/anaconda3/envs/quant/bin/python scripts/ingest/fetch_sec_filings_sample.py --symbols AAPL,MSFT,JPM
"""
...
from core.data.vendors.sec import build_filings_sample, fetch_company_tickers
