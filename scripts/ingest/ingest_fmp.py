...
Usage:
    ...
    python scripts/ingest/ingest_fmp.py --wave 1,2 --dry-run

    # run waves 1 and 2
    python scripts/ingest/ingest_fmp.py --wave 1,2

    # one endpoint, re-fetching what exists
    python scripts/ingest/ingest_fmp.py --endpoints earnings --force

    # what happened last run
    python scripts/ingest/ingest_fmp.py --report
"""
...
from core.data.vendors.fmp.keys import (
    ECONOMIC_INDICATORS,
