...
Usage:
    ...
    python scripts/ingest/update_sectors.py --refresh-days 60  # Custom refresh period
    python scripts/ingest/update_sectors.py --retry-unknown    # Only retry unknowns
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python scripts/ingest/update_sectors.py",
    )
    parser.add_argument(
        "--refresh-days",
        type=int,
    ...
    parser.add_argument(
        "--retry-unknown", action="store_true", help="Only retry symbols marked as Unknown"
    )
    ...
    print(f"  python scripts/ingest/update_sectors.py")
    print()
