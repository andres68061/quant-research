...
(scripts/ops/scan_data_quality.py), findings show up on the frontend Data Coverage
page, and decisions are recorded here. Decisions survive rescans.

Usage:
    # list open findings
    /opt/anaconda3/envs/quant/bin/python scripts/ops/review_quarantine.py --list

    # clear a finding (keep the data) with a justification
    /opt/anaconda3/envs/quant/bin/python scripts/ops/review_quarantine.py \
