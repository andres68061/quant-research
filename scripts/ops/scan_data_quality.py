...
Run after every data update (scripts/ingest/update_daily.py invokes this automatically).

Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/ops/scan_data_quality.py
"""
