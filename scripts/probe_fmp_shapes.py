...
``scripts/validate_fmp_manifest.py`` before starting a long ingestion.

Usage:
    python scripts/probe_fmp_shapes.py --out config/vendors/fmp.json
    python scripts/probe_fmp_shapes.py --shapes-only --out /tmp/shapes.json
"""
