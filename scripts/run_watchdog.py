...
2. ``logs/watchdog.log`` — the audit trail. Passive.
...
Usage:
    /opt/anaconda3/envs/quant/bin/python scripts/run_watchdog.py
    /opt/anaconda3/envs/quant/bin/python scripts/run_watchdog.py --deep
    /opt/anaconda3/envs/quant/bin/python scripts/run_watchdog.py --set-baseline
"""
...
from core.data.watchdog import (  # noqa: E402
    current_row_counts,
    run_watchdog,
    write_baseline,
    write_status,
